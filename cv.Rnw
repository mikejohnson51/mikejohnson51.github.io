...
\vspace{2mm}
\centerline{\textcolor{header_blue}{\textcolor{gray}{\faGlobe} \hspace{0.2mm} \url{ https://mikejohnson51.github.io}} $|$ \textcolor{gray}{\faEnvelope} \hspace{0.2mm} \href{mailto:jmj00@ucsb.edu }{jmj00@ucsb.edu}}
...
software <- software %>% 
  ...
  select(main, short_desc, homepage)

col2 <- paste0('{',bold(software$short_desc), '}', ' NEWLINE ', 'URL', software$homepage)
