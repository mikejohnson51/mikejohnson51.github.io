...
create_table <- function(table = NULL, file_name = NULL, removeHeaders = TRUE) {
  ...
  fileConn<-file(paste0('docs/generated_html_files/',file_name))
...
# Create HTML file
htmlwidgets::saveWidget(affiliation_map, file =  paste0(getwd(),"/docs/generated_html_files/affiliations_map.html"))
...
fileConn<-file('docs/generated_html_files/footer.html')
...
fileConn<-file('docs/generated_html_files/current_work.html')
...
fileConn<-file('docs/generated_html_files/software.html')
writeLines(html, fileConn)
close(fileConn)
@
